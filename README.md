...
1. Generate an application's configuration file using pre-built presets with the help of [rika](https://github.com/b-zago/rikami) CLI that uses my custom made Go's template processor.
